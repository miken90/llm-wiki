...
| Keyword search | `Grep` / `grep` | Search in `{{WIKI_ROOT}}/wiki/` |
| Browse index | `Read` / `cat` | `{{WIKI_ROOT}}/wiki/index.md` |
| Read wiki page | `Read` / `cat` | `{{WIKI_ROOT}}/wiki/concepts/foo.md` |
| List pages | `Glob` / `find` | `{{WIKI_ROOT}}/wiki/**/*.md` |
| Create page | `Write` / `create` | `{{WIKI_ROOT}}/wiki/entities/foo.md` |
| Update page | `Edit` | `{{WIKI_ROOT}}/wiki/entities/foo.md` |
